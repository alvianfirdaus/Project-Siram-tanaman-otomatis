...
class _GrafikBulananWidgetState extends State<GrafikBulananWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedData == "Nutrisi (NPK)") {
      ...
      nData = generateFullMonthSpots(npk['n'] ?? {});
      pData = generateFullMonthSpots(npk['p'] ?? {});
      kData = generateFullMonthSpots(npk['k'] ?? {});
    } else {
      String key;
      switch (selectedData) {
                    ...
                    : selectedData == "Kelembaban Udara"
                      ...
                      : selectedData == "Suhu"
                          ...
                          : selectedData == "Kelembaban Tanah"
                              ? [
                                  LineChartBarData(spots: singleData, isCurved: true, color: Colors.brown, barWidth: 3), // Custom color for Humidity
                                ]
                              : [
                                  LineChartBarData(spots: singleData, isCurved: true, color: Colors.blue, barWidth: 3), // Default color
                                ],
