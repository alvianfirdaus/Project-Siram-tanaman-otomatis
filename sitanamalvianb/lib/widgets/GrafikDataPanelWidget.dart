      ...
      for (var key in sortedTimes) {
        ...
        if (value is Map) {
          ...
          if (selectedPlot == "Nutrisi (NPK)") {
            nData.add(FlSpot(timeValue, (value['n'] ?? 0).toDouble()));
            pData.add(FlSpot(timeValue, (value['p'] ?? 0).toDouble()));
            kData.add(FlSpot(timeValue, (value['k'] ?? 0).toDouble()));
            ...
            soilMoistureData.add(FlSpot(timeValue, (value['soilMouisture'] ?? 0).toDouble()));
          } else if (selectedPlot == "Suhu") {
            temperatureData.add(FlSpot(timeValue, (value['temperature'] ?? 0).toDouble()));
          }
        }
      }
    }
              ...
              children: [
                ...
                DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: ["Nutrisi (NPK)", "Kelembaban Udara", "Kelembaban Tanah", "Suhu"].map((String value) {
